...
#If You didn't rename the drive label ending with L or R
# you can use the following line to set the split side
#split_side = SplitSide.RIGHT
#split_side = SplitSide.LEFT


split = Split(split_type=SplitType.UART, split_flip=True, split_target_left=True,uart_flip = False ,use_pio=True)
